    ...
    <main className="relative isolate bg-dust-grey-50 px-6 pb-5 pt-2 sm:pb-5 sm:pt-3 lg:px-8">
      ...
      >
        <div
          ...
          className="relative left-1/2 -z-10 aspect-1155/678 w-xl max-w-none -translate-x-1/2 rotate-6 bg-linear-to-tr from-dust-grey-50 to-dust-grey-500 opacity-60 sm:left-[calc(50%-30rem)] sm:w-6xl"
        />
      </div>
